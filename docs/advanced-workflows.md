# Advanced workflows and implementation notes

[Back to the README](../README.md) · [Current Studio manual](studio-tutorial.en.md)

Run the command examples below from the repository root. This reference preserves the detailed installation, research, training and implementation notes previously included in the README. For current interface labels and the everyday editing workflow, use the Studio manual.
